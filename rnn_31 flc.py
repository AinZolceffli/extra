...
plt.plot(split_2017_2018['date'][:len(actuals)], actuals, label='Actual Price', color='black', linewidth=2)
...
for _ in range(1):
	...
	plt.plot(split_2017_2018['date'][:len(predictions)], predictions, color='red', alpha=0.7)  # Red, semi-transparent
...
# Add legend
plt.legend(['Actual Price', 'Predictions (20 runs)'])
